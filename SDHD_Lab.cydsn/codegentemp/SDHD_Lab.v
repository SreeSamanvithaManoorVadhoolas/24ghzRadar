// ======================================================================
// SDHD_Lab.v generated from TopDesign.cysch
// 07/15/2024 at 20:13
...
module WaveDAC8_v2_10_2 (
	...
	cy_clock_v1_0
		#(.id("81d8d99d-472a-4074-85cb-eca38832b280/77086516-855e-4b7b-abbe-47b22f8543de"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
...
module ADC_DelSig_v3_30_3 (
	...
	cy_clock_v1_0
		#(.id("713ec2eb-f83b-4189-9761-81090bb62e8d/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("713ec2eb-f83b-4189-9761-81090bb62e8d/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("7812500000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("afb11e80-4811-415a-a14a-0bc8e9478963"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5ecf87e6-b0e5-4145-8f1e-bbea6d4e1b5c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2ee84d84-5d6e-4189-b37d-c4691c7a0c42"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
